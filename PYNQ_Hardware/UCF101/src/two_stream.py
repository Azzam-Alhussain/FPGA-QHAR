...
from ucf101_simpnet_spatial import ucf101_simpnet_spatial
from ucf101_simpnet_temporal import ucf101_simpnet_temporal
...
#         self.model_spatial = simple_net(config, cnn_acc0)
        self.model_spatial = ucf101_simpnet_spatial('./files/params/ucf101_simpnet/spatial_model.pickle', config, cnn_acc0)

#         self.model_temporal = simple_net_2(config, cnn_acc1)
        self.model_temporal = ucf101_simpnet_temporal('./files/params/ucf101_simpnet/temperal_model.pickle', config, cnn_acc1)
