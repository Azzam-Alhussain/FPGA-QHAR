...
def make_layers(config, in_channel=3, accelerator=None):
    ...
    layers += [fpga_nn.Linear(1024,int(in_height/64)*int(in_width/64)*64), quantize = False]
...
if __name__ == "__main__":
    ...
    model_path = './files/params/ucf24_vgg7/model.pickle'
