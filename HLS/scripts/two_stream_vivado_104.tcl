...
set hls_lk_impl_path LK_Optical_Flow_Quantized/HLS_LK/solution1/impl  
# CNN HLS implement path <<<<<<<記得改路徑>>>>>>
set hls_cnn_impl_path ConvCNN_Quantized/HLS_PROJ/medium/impl
# Vivado project path <<<<<<<記得改路徑>>>>>>
set vivado_path vivado

# create new project
#~ create_project vivado ${vivado_path} -part xczu9eg-ffvb1156-2-e -force
create_project vivado ${vivado_path} -part xczu7ev-ffvc1156-2-e -force
# 102
